...
{
    public class UsingRhinoFilesBusWithAlternateStorageLocation : WithDebugging, IDisposable
    {
        ...
        public UsingRhinoFilesBusWithAlternateStorageLocation()
        {
            ...
            var hostConfiguration = new HostConfiguration()
                .AddAssembly(typeof(RhinoFilesTransport).Assembly)
                .StoragePath(alternateStorageLocation)
                .Bus("file://localhost/test_queue2", "test")
                .Receive("Rhino.ServiceBus.Tests", "file://localhost/test_queue");
